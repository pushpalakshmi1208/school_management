    ...
    <div class="container-fluid mt-5">
        <div class="card">
            <div class="card-header text-center" style="background:#2a5a3b;  color: white;">
                <h2 class="text-center">Failed Students List</h2>
            </div>
        ...
        if ($result->num_rows > 0) { ?>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td <?php echo $row["tamil"] < $passing_mark ? 'class="text-danger"' : ''; ?>>
                                        <?php echo $row["tamil"]; ?>
                                    </td>
                                    <td <?php echo $row["english"] < $passing_mark ? 'class="text-danger"' : ''; ?>>
                                        <?php echo $row["english"]; ?>
                                    </td>
                                    <td <?php echo $row["maths"] < $passing_mark ? 'class="text-danger"' : ''; ?>>
                                        <?php echo $row["maths"]; ?>
                                    </td>
                                </tr>
                    <?php
